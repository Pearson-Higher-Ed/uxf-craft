...
<html lang="en">
<head>
    <title>Code coverage report for StaticAlert/StaticAlert.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">StaticAlert</a> StaticAlert.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  typeCheck = () =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.type === 'Success') {
      return (
